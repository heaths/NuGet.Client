...
namespace NuGet.Commands
{
    ...
    public class TrustedSignersCommandRunner : ITrustedSignersCommandRunner
    {
        ...
        public async Task<int> ExecuteCommandAsync(TrustedSignersArgs trustedSignersArgs)
        {
            ...
            var actions = new TrustedSignerActions(_trustedSignersProvider);
                ...
                switch (trustedSignersArgs.Action)
                {
                    ...
                    case TrustedSignersAction.Add:
                        ...
                        if (isPackagePathProvided)
                        {
                            ...
                            {
                                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Strings.Error_NoSignatureTrustedForPackage, trustedSignersArgs.PackagePath));
                            }
                            ...
                            foreach (var package in packagesToTrust)
                            {
                                ...
                                {
                                    await actions.AddTrustedSignerAsync(
                        ...
                        if (isServiceIndexProvided)
                        {
                            ...
                            await actions.AddTrustedRepositoryAsync(
                                trustedSignersArgs.Name,
                                serviceIndex,
                                trustedSignersArgs.Owners,
                                CancellationToken.None);
                        ...
                        if (isFingerprintProvided)
                        {
                            ...
                            actions.AddOrUpdateTrustedSigner(
                                trustedSignersArgs.Name,
                    ...
                    case TrustedSignersAction.Sync:
                        ...
                        await actions.SyncTrustedRepositoryAsync(trustedSignersArgs.Name, CancellationToken.None);
        ...
        private void ValidateListArguments(TrustedSignersArgs args)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Strings.Error_CouldNotList, Strings.Error_InvalidCombinationOfArguments));
            }
        }
        ...
        private void ValidateRemoveArguments(TrustedSignersArgs args)
        {
            ...
            if (isPackagePathProvided || isServiceIndexProvided ||
                ...
                isUntrustedRootProvided || isAuthorProvided || isRepositoryProvided)
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Strings.Error_CouldNotRemove, Strings.Error_InvalidCombinationOfArguments));
            }
        }
        ...
        private void ValidateSyncArguments(TrustedSignersArgs args)
        {
            ...
            if (isPackagePathProvided || isServiceIndexProvided ||
                ...
                isUntrustedRootProvided || isAuthorProvided || isRepositoryProvided)
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Strings.Error_CouldNotSync, Strings.Error_InvalidCombinationOfArguments));
            }
        }
        ...
        private void ValidateNameExists(string name)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Strings.Error_PropertyCannotBeNullOrEmpty, nameof(name)));
            }
        }
